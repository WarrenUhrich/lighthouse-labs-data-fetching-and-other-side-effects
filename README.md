...
[GitHub Repository Branch](https://github.com/WarrenUhrich/lighthouse-labs-data-fetching-and-other-side-effects/tree/2023.08.17-web-flex-day-17april2023) | [Vimeo Video Recording](https://vimeo.com/855483517/53e9fe7a18?share=copy)
...
* Locations: [http://localhost:8080/api/locations](http://localhost:8080/api/locations)
* Students: [http://localhost:8080/api/students](http://localhost:8080/api/students)
